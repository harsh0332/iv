...
export default function WhyIvyEstate() {
  const sellingPoints = [
    {
      id: "university",
    ...
    {
      id: "legal",
      title: "RERA-Approved Gated Layout",
      description: `100% RERA-registered layout (No. ${projectData.reraNumber}) with cleared titles, offering a legally compliant and secure plotted development structure.`,
